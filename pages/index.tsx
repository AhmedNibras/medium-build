...
export default function Home({ posts }: Props) {
  ...
  return (
    <div className="max-w-7xl mx-auto ">
      ...
      <div className="flex justify-between items-center bg-yellow-400 border-y border-black py-12 lg:py-12">
        ...
        <div className="px-10 space-y-5">
          ...
          <h2>It's easy and free to post your thinking on any topic and connect with million if readers</h2>
        </div>
            ...
            <div className="border rounded-lg group cursor-pointer overflow-hidden">
              ...
              <div className="flex justify-between p-5 bg-white">
                <div>
                  ...
                  <p className="text-xs">{post.description} by {post.author.name}</p>l
                </div>
                <img 

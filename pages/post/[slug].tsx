  ...
  <main>
    ...
    <article className="max-w-3xl mx-auto p-5">
        ...
        {submitted ? (
            ...
            <input className="shadow bg-yellow-500 hover:bg-yellow-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded cursor-pointer" 
            type="Submit" 
            />
        </form>
        )}
